...
# from saucedemo.pages.checkout_page.locators import CheckoutPageLocators as locators
...
class CheckoutPage:
    ...
    def verify_form_elements_visible(self):
        expect(self.page.locator(locators.FIRST_NAME_INPUT)).to_be_visible()
        expect(self.page.locator(locators.LAST_NAME_INPUT)).to_be_visible()
        expect(self.page.locator(locators.POSTAL_CODE_INPUT)).to_be_visible()
        expect(self.page.locator(locators.CONTINUE_BUTTON)).to_be_visible()
